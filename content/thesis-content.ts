...
export const thesisContent: ThesisContent = {
  ...
  resultsData: {
    ...
    energyVsCorrectness: {
      ...
      data: [
        { version: "Baseline Straight", energy: 1.1, correctness: 60, color: "#0F9ED5" },
        { version: "Baseline CoT", energy: 1.2, correctness: 65, color: "#0F9ED5" },
        { version: "Baseline Retrieval", energy: 1.3, correctness: 75, color: "#0F9ED5" },
    ...
    performanceComparison: {
      title: "Performance Comparison: 8B vs. 14B Models",
      description: "Comparison of the 8B parameter model with routing system against a 14B parameter model, showing accuracy and energy consumption.",
      models: [
        {
          name: "8B Baseline",
          parameters: "8B",
    ...
    energyDistribution: {
      ...
      data: [
        { version: "Baseline", cpu: 0.2, gpu: 0.9 },
        { version: "V2", cpu: 0.5, gpu: 1.4 },
        { version: "V4", cpu: 0.4, gpu: 1.3 },
        { version: "V5", cpu: 0.45, gpu: 1.3 },
        { version: "V6", cpu: 0.3, gpu: 1.9 },
      ],
    },
  },
  resourcesAuthor: {
    ...
    downloads: {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Citation information in BibTeX format",
          href: "#",
          type: "bibtex",
        },
      ],
